(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@chaospad/ngaox', ['exports', '@angular/core', '@angular/platform-browser', '@angular/common', '@angular/router'], factory) :
    ...
    var SeoService = /** @class */ (function () {
        ...
        SeoService.prototype.generateTags = function (Tags) {
            var tags = Object.assign({ title: "Chaospad", description: "Connect to chaospad & make your chaos over the interner.", image: "https://res.cloudinary.com/chaospad/logo.png" }, Tags);
    ...
    var NgaoxModule = /** @class */ (function () {
        function NgaoxModule() {
        }
        return NgaoxModule;
    }());
    ...
    ***************************************************************************** */
    ...
    SidebarComponent.propDecorators = {
        routes: [{ type: i0.Input, args: ["routes",] }]
    };
    ...
    NavbarModule.decorators = [
        { type: i0.NgModule, args: [{
                    declarations: __spread(EXPORTS),
                    imports: [
                        common.CommonModule,
                        router.RouterModule
                    ],
                    exports: __spread(EXPORTS, [
                        router.RouterModule
                    ])
                },] }
    ];
...
//# sourceMappingURL=chaospad-ngaox.umd.js.map
